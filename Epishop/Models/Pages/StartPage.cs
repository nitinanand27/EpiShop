...
namespace Epishop.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder), typeof(EventPage) }, // Pages we can create under the start page...
